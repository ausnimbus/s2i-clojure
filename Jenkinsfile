...
node {
        ...
        */
        ...
        def testApp = openshift.newApp("https://github.com/ausnimbus/clojure-ex", "--image-stream=s2i-clojure:${tag}", "-l app=clojure-ex");
        ...
        openshift.tag("ausnimbus-ci/s2i-clojure:${tag}", "ausnimbus/s2i-clojure:${tag}")
}
